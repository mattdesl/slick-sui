 ...
 * {@link SuiArrowButton#getScrollButtonAngle(SuiScrollBar, int)}, which determines
 ...
 */
public class SuiArrowButton extends SuiButton {
     ...
     */
    public SuiArrowButton(float angle) {
        super();
        this.angle = angle;
