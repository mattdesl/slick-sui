 ...
 * @author davedes
 */
public class SuiSlider extends SuiContainer implements ScrollConstants {
        
    /** The "thumb" or "knob" button for this slider component. */
    protected SuiButton thumbButton = null;
    ...
    /** Creates a new instance of SuiSlider with the specified orientation. */
    public SuiSlider(int orientation) {
    ...
    public SuiButton getThumbButton() {
        return thumbButton;
    }
    ...
    protected class TrackListener extends SuiMouseAdapter implements SuiActionListener {
        ...
        private void jump(int button, int targetX, int targetY) {
            ...
            if (button!=SuiMouseEvent.BUTTON1 && slideDelay.isRunning()) {
                lastIncrementing = incrementing = 0;
                slideDelay.stop();
                return;
            }
            ...
            trackDown = contains && button!=SuiMouseEvent.NOBUTTON && !thumbCont;
    ...
    protected class ThumbDragListener extends SuiMouseAdapter {
