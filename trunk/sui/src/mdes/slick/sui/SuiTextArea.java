 ...
 * @author davedes
 */
public class SuiTextArea extends SuiTextComponent {
    ...
    public SuiTextArea(int cols, int rows) {
        this(null, 0, 0);
    }
    
    /** Creates a new instance of SuiTextField */
    public SuiTextArea(String text, int cols, int rows) {
        this();
        setText(text);
    ...
    /** Creates a new instance of SuiTextArea */
    SuiTextArea(boolean updateAppearance) {
