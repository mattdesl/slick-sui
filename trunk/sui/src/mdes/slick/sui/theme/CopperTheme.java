 ...
 * CopperTheme.java
 *
 * Created on November 11, 2007, 6:47 PM
 */
...
public class CopperTheme implements SuiTheme {
    ...
    private Color primary1 = new ColorUIResource(179, 141, 127);//new ColorUIResource(204, 158, 124);
    private Color primary2 = new ColorUIResource(229, 177, 139);
    private Color primary3 = new ColorUIResource(153, 137, 125);//new ColorUIResource(133, 117, 105);
    ...
    private Color secondaryBorder1 = new ColorUIResource(96,103,113);//new ColorUIResource(133, 117, 105);
