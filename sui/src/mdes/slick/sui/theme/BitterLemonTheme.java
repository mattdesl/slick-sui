/*
 * BitterLemonTheme.java
 *
 * Created on November 11, 2007, 6:07 PM
 */
...
public class BitterLemonTheme implements SuiTheme {
    ...
    private Color primary1 = new ColorUIResource(202,205,218);//new ColorUIResource(184, 187, 203);
    ...
    private Color secondary1 = new ColorUIResource(175, 201, 75);//new ColorUIResource(195, 221, 95);
    private Color secondary2 = new ColorUIResource(210, 240, 93);
    private Color secondary3 = new ColorUIResource(111, 133, 21);//new ColorUIResource(151, 173, 61);
    ...
    public String getName() { return "Bitter Lemon"; }
